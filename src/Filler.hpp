...
public:
    ...
    template<size_t span>
    void contigGapFill(std::string & infostring, int tid, string sourceSequence, string targetSequence, vector<filled_insertion_t>& filledSequences,int nb_mis_allowed, bkpt_dict_t targetDictionary,bool reverse );
