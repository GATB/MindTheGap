...
// fill use for -contig
template<size_t span>
void Filler::fillContig<span>::operator () (Filler* object)
{
    //retrieve the AbundanceMap : mphf with the abundance for each kmer
    size_t kmerSize = object->_kmerSize;
    ...
    int nbBreakpoints=0;
       ...
       // cout << "SeedSeq" << seedk << endl;
        ...
        object->contigGapFill<span>(infostring,0, sourceSequence, targetSequence,filledSequences, begin_kmer_repeated,end_kmer_repeated, targetDictionary );
